...
last_activity: 2026-07-01 -- ordinal severity re-test (DILIrank SeverityClass 0-8): omics negative on the graded target too; best=RF on structure; measured DE at/below chance; switching binary->ordinal does not rescue omics. Committed f621edf. Earlier 2026-07-01: tox-tuned E/F halt gate fired (9e2d108); fusion/omics-signal investigation (6c538b5, f4b6a63, fe29dca). 2026-06-30: encoder sweep (08909ae), writeup (6e153a6), lab-meeting package (045f3dd).
progress:
  total_phases: 8
  completed_phases: 2
  total_plans: 11
